...
def handle_logout():
    """Tizimdan chiqish funksiyasi - to'liq tozalangan"""
    try:
        # Cookie'ni o'chirish
...
with st.sidebar:
    ...
    if st.button("📥 Chatni yuklab olish", use_container_width=True, key="download_chat"):
    ...
    temperature = st.slider("🌡 Ijodkorlik darajasi", 0.0, 1.0, 0.6, 0.1, key="temp_slider")
    st.caption("Pastroq - aniqroq, yuqoriroq - ijodiyroq")
    
    st.markdown("<br>"*5, unsafe_allow_html=True)
    
    # Tizimdan chiqish tugmasi - yangilangan
