...
with st.sidebar:
    ...
    # Rasmiy Cerebras model nomlari (docs dan)
    model_name = st.selectbox("Model:", [
        "llama-3.3-70b",   # katta, kuchli
        "llama3.1-8b",     # kichik, tez
...
if prompt := st.chat_input("Somo AI ga xabar yuboring..."):
    ...
    with st.chat_message("assistant"):
        ...
        # Avval tanlangan model, xato bo'lsa llama3.1-8b ga o'tadi
        ...
        for try_model in models_to_try:
            try:
                ...
                if "404" in err or "not_found" in err:
                    continue  # boshqa modelni sinab ko'r
        ...
        if not success:
            full_response = "❌ Hech qanday model ishlamadi. API kalitingiz yoki tarmoqni tekshiring."
            placeholder.markdown(full_response)
